---
name: tasks
description: Build an atomic execution task list from the implementation plan. Reads .ai/current automatically. Outputs specs/<type>/<slug>/tasks.md.
---
...
`specs/features/<slug>/tasks.md` (or `specs/bugs/<slug>/tasks.md`).
