---
description: Switch the active spec without running /spec again. Lists available specs or switches to a named one.
arguments: (optional) Feature slug or path. Omit to list all available specs.
output: Updates .ai/current + confirmation message
---
